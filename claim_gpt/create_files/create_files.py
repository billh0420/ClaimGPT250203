...
def create_files(output_folder_path: Path, corpus01_file_path: Path, block_size: int, limit_count: int) -> Path:
    ...
    if not corpus_file_path.exists():
        create_claim_corpus(corpus_file_path=corpus_file_path, corpus01_file_path=corpus01_file_path)
